...
::: practice
Utilisez le dataframe `nigerm04` pour créer un graphique à barres des cas hebdomadaires, et remplissez toutes les barres avec la même couleur. Mappez `cases` sur l'axe des y, `week` sur l'axe des x, et fixez l'esthétique `fill` des barres à la couleur R "hotpink".
...
# Solutions des exercices pratiques {.unnumbered}
