...
This is the document that matches the lesson HTML notes on our website. 
...
mute(here::here("autograder/ls03_line_autograder.R"))
```
...
# Check your answer:
.CHECK_q2() # Note this only works with line type "dotdash" and point color "aquamarine"
```
:::
